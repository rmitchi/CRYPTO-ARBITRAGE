...
class HuobiDataStreamerFutures(Thread):
	...
	BASE_URL = "wss://api.hbdm.com/linear-swap-ws"
	...
	def on_message(self, wsapp, message) -> None:
		...
		ltp = float(msg['tick']['data'][-1]['price'])
		qty = float(msg['tick']['data'][-1]['quantity'])
